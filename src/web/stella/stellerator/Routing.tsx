...
export function Routing(props: Props) {
    return (
        <Switch>
            <Route exact path="/cartridge-manager" component={CartridgeManager as any} />
            <Route exact path="/emulation" component={Emulation as any} />
            <Route exact path="/settings" component={Settings as any} />
            <Route exact path="/help" component={Help as any} />
